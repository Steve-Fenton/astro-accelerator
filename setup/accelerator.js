...
copyRecursiveSync('./node_modules/astro-accelerator/public/css/', './public/css/', true);

copyRecursiveSync('./node_modules/astro-accelerator/src/pages/search.json.ts', './src/pages/search.json.ts', true);

copyRecursiveSync('./node_modules/astro-accelerator/src/pages/sitemap.xml.ts', './src/pages/sitemap.xml.ts', true);
...
copyRecursiveSync('./node_modules/astro-accelerator/src/layouts/', './src/layouts/', true);

copyRecursiveSync('./node_modules/astro-accelerator/src/pages/search.md', './src/pages/search.md', true);
